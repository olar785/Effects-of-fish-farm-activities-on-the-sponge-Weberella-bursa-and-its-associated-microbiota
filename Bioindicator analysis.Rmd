...
res_s <- DESeq2::lfcShrink(dds, contrast=c("condition","Cage","Reference"), res=res, type = "ashr")
# Sort by p-value
...
```{r}
# Filtering taxa to keep the most important/abundant only
...
# Adding percent of nitrogen per dry weigth on percent of carbon per dry weigth
